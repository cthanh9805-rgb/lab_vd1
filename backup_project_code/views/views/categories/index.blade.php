        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span style="background:rgba(56,189,248,0.15); color:var(--accent-light); padding:4px 12px; border-radius:12px; font-weight:700; font-size:12px;">
                    ...
                    <td>
                        <div style="display:flex; gap:6px;">
                            ...
                            <form action="{{ route('categories.destroy', $category->id) }}" method="POST"
                                  style="display:inline;" onsubmit="return confirm('Xoá danh mục này? Tất cả sản phẩm thuộc danh mục cũng sẽ bị xoá!')">
                                @csrf
                                @method('DELETE')
